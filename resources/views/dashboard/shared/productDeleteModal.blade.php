    ...
    <div class="relative w-full max-w-md px-4 h-full md:h-auto">
        ...
        <div class="bg-white rounded-lg shadow relative">
            ...
            <div class="p-6 pt-0 text-center">
                ...
                <h3 class="text-lg font-normal text-gray-500 mt-5 mb-6">Are you sure you want to delete
                    "<span id="productDeleteName" class="font-semibold"></span>" ?
                </h3>
                <form action="/deleteProductFromDatabase" method="POST"
