...
<head>
    ...
    <meta name="description"
        content="Get started with a premium Tailwind CSS dashboard template featuring 21 pages including charts, kanban board, products, users, authentication pages, and more based on the Flowbite library">
...
<div class="h-screen w-screen bg-white flex items-center">
    <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
        <div class="max-w-md">
            <div class="text-6xl font-dark font-bold mb-3">404</div>
            ...
            <a href="/home">
                <button
                    class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700">Homepage</button>
            </a>
        </div>
        <div class="max-w-lg">
